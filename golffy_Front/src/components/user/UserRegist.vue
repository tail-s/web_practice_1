    ...
    <div class="login-container">
      <section class="login" id="login">
        ...
        <form class="login-form">
          <input type="text" v-model="user_nick" class="login-input" placeholder="Name" />
          <input
            type="text"
            v-model="user_id"
            class="login-input"
          ...
          <div class="submit-container">
            <button class="login-button" @click.prevent="back">CANCEL</button>
            <button class="login-button" @click.prevent="send">SIGN UP</button>
          </div>
        </form>
      </section>
    </div>
